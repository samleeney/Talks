...
\begin{frame}
	\begin{center}
		% Title
		{\Huge New Data Analysis Methods for Radiometer Calibration\par}
		\vspace{0.5cm}
		...
		% Image at the bottom
		\includesvg[width=1\textwidth]{affiliations.svg}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.8\textwidth}
			\begin{figure}[h]
				\centering
				\includegraphics[width=\textwidth]{combined_histograms.png}
			\end{figure}
		\end{column}
		\begin{column}{0.2\textwidth}
...
\begin{frame}{APPENDIX A: Fudge Factors}
	\begin{figure}[h]
		\centering
		\begin{minipage}{0.7\textwidth}
			\includegraphics[width=\textwidth]{ian_ff.png}
			\caption{Credit Roque 2020}
		\end{minipage}
		\hfill
		\begin{minipage}{0.25\textwidth}
			$T_{L}$ should be spectrally flat, however it has structure because we are including a fudge factor in the fit to account for other uncertain approximations in the derivation.
		\end{minipage}
	\end{figure}
\end{frame}
