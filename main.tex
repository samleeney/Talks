...
\begin{frame}
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[right=-4.7cm, above=-4.3cm] at (current page.center)
    {
    \includegraphics[width=0.25\textwidth]{cam_logo.jpg}
    };
  \end{tikzpicture}

  \begin{tikzpicture}[remember picture, overlay]
    \node[right=1.3cm, above=-5cm] at (current page.center)
    {
    \includegraphics[width=0.2\textwidth]{erc.jpg}
    };
  \end{tikzpicture}
