...
\begin{frame}
	\begin{center}
		...
		% Image at the bottom
		\includesvg[width=1\textwidth]{images_compressed/affiliations.svg}
...
% 	\begin{figure}[h]
% 		\centering
% 		\includesvg[width=0.6\textwidth]{images_compressed/whatiscal.svg}
% 	\end{figure}
% 	\vfill
% \end{frame}
...
% 	\begin{figure}[h]
% 		\centering
% 		\includesvg[width=0.55\textwidth]{images_compressed/howtocal.svg}
% 	\end{figure}
% 	\vspace{0.7cm}
% 	\vfill
% \end{frame}
...
% 	\begin{figure}[h]
% 		\centering
% 		\includegraphics[width=0.6\textwidth]{images_compressed/antenna.png}
% 	\end{figure}
%
% 	\begin{center}
% 		\begin{tikzpicture}
...
% 	\begin{figure}[h]
% 		\centering
% 		\includegraphics[width=0.9\textwidth]{images_compressed/intro_receiver.pdf}
...
% 			\begin{figure}[h]
% 				\includesvg[width=0.9\textwidth]{images_compressed/mlcal.svg}
% 			\end{figure}
% 		\end{column}
% 	\end{columns}
% \end{frame}
...
\begin{frame}{\small{ML calibration overview}}
	\begin{columns}
		\begin{column}{0.48\textwidth}
			\begin{figure}
				\centering
				\includesvg[width=\textwidth]{images_compressed/instrument.svg}
			\end{figure}
		\end{column}
		...
		\begin{column}{0.48\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=\textwidth]{images_compressed/ml_overview.pdf}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{\small{Testing on internal validation source}}
    \begin{figure}
        \centering
        \includegraphics[width=0.55\textwidth]{images_compressed/temps.pdf}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images_compressed/temps.pdf}
% 			\end{figure}
% 		\end{column}
% 		\begin{column}{0.5\textwidth}
% 			\begin{figure}
% 				\centering
% 				\includesvg[width=0.9\textwidth]{images_compressed/instrument.svg}
% 			\end{figure}
% 		\end{column}
% 	\end{columns}
% \end{frame}
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=0.7\textwidth]{images_compressed/githubrepo.png}
% 	\end{figure}
% \end{frame}
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=0.6\textwidth]{images_compressed/validation_calibrator.pdf}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images_compressed/signal_comparison.pdf}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images_compressed/signal_triangle_plot.pdf}
...
\begin{frame}{\small{Neural Network Time Evolution}}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{images_compressed/nn_time.pdf}
    \end{figure}
\end{frame}

\begin{frame}{\small{Inject system drift}}
	\centering
	\includegraphics[width=\textwidth]{images_compressed/temps_combined_2d.pdf}
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=]
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=0.8\textwidth]{images_compressed/pasted_image_20250403112230.png}
% 	\end{figure}
% \end{frame}
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=0.8\textwidth]{images_compressed/pasted_image_20250410111857.png}
% 	\end{figure}
% \end{frame}
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=\textwidth]{images_compressed/paper_front.png}
% 	\end{figure}
% \end{frame}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images_compressed/pasted_image_20250515095127.png}
% 			\end{figure}
% 		\end{column}
...
\begin{frame}{\small{Modeling environmental features}}
    \begin{columns}[c]
        \begin{column}{0.55\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{images_compressed/nn_time_tpm.pdf}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=\textwidth]{images_compressed/pasted_image_20250605135110.png}
% 			\end{figure}
% 		\end{column}
% 	\end{columns}
% \end{frame}
