...
% 	\begin{figure}[h]
% 		\centering
% 		\includegraphics[width=0.6\textwidth]{images/whatiscal.png}
% 	\end{figure}
% 	\vfill
% \end{frame}
...
% 	\begin{figure}[h]
% 		\centering
% 		\includegraphics[width=0.55\textwidth]{images/howtocal.png}
% 	\end{figure}
% 	\vspace{0.7cm}
% 	\vfill
% \end{frame}
...
% 			\begin{figure}[h]
% 				\includegraphics[width=0.9\textwidth]{images/mlcal.png}
% 			\end{figure}
% 		\end{column}
% 	\end{columns}
% \end{frame}
...
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images/temps.png}
% 			\end{figure}
% 		\end{column}
% 		\begin{column}{0.5\textwidth}
% 			\begin{figure}
% 				\centering
% 				\includegraphics[width=0.9\textwidth]{images/instrument.png}
% 			\end{figure}
% 		\end{column}
% 	\end{columns}
% \end{frame}
